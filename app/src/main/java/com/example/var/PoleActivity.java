...
public class PoleActivity extends Activity implements OnTouchListener, CvCameraViewListener2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Sets the look of the screen when this class is called to be R.layout.activity_pole
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        //This sets the color of the pole in ColorBlobDetector, use mColorRadius to change range of colors
